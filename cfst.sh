...
then
    ...
    gcc -D TARGET=x86_64 -D TARGETNUM=3 -D __TESTING__=0 -O0 -std=c99 -pedantic -Wno-builtin-declaration-mismatch -ffreestanding -nostartfiles -nostdlib -nodefaultlibs -static -c -o ./bin/tsfs.out ./os/kernel/filesystems/tsfs.c
