...
char test_dataheader(FileSystem*, _kernel_u32);
char test_datablock(FileSystem*, _kernel_u32);
char test_structnode(FileSystem*, _kernel_u32);
char test_structblock(FileSystem*, _kernel_u32);
