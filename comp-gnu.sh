...
i686-linux-gnu-gcc -std=c99 -Wpedantic -m32 -march=i386 -nostartfiles -nostdlib -nodefaultlibs -static -c -o sysc.elf sys32/sys.c
i686-linux-gnu-ld --no-dynamic-linker -T ./newf386 -o kernel.elf kernel.o sysc.elf irupts.o -lgcc
...
i686-linux-gnu-gcc -std=c99 -Wpedantic -m32 -march=i386 -nostartfiles -nostdlib -nodefaultlibs -static -c -o prgm-ul.elf os/system.c
...
i686-linux-gnu-ld --no-dynamic-linker -T ./newf386 -o prgm.elf prgm-ul.elf prgm-asm.elf -lgcc
dd if=prgm.elf of=stall.bin bs=512 seek=66
i686-linux-gnu-gcc -std=c99 -Wpedantic -m32 -march=i386 -nostartfiles -nostdlib -nodefaultlibs -static -c -o shell-ul.elf os/shell.c
i686-linux-gnu-as -march=i386 -o shell-asm.elf os/shell.s
i686-linux-gnu-ld --no-dynamic-linker -T ./newf386 -o shell.elf shell-ul.elf shell-asm.elf -lgcc
